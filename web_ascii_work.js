...
const MODEL_PROFILES = {
  ...
  "specter_mesh_refined.csv": { zoom: 76.0, distance: 60.0, speedA: 0.0, speedB: 0.18, speedC: 0.0, edgeThreshold: 0.001, glow: false, charset: " .:-=+*#%@", useMask: false, twoSided: false, baseBright: 0.08, light: [0.48, -0.4, 0.9] },
  "bullfinch_mesh.csv": {
    zoom: 74.0,
    distance: 54.0,
    speedA: 0.03,
