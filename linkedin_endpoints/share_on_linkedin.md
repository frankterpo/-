---
layout: Conceptual
title: Share on LinkedIn - LinkedIn | Microsoft Learn
canonicalUrl: https://learn.microsoft.com/en-us/linkedin/consumer/integrations/self-serve/share-on-linkedin
...
description: Learn how to leverage LinkedIn's Share API to share meaningful content to your LinkedIn network.
author: chrisou
ms.author: li_chrou
ms.date: 2021-02-05T00:00:00.0000000Z
ms.topic: article
ms.service: linkedin
locale: en-us
document_id: c57452ad-fbad-afdb-e4ae-f147a201d4ed
document_version_independent_id: 3670154a-8296-9aaa-872d-bff837c0c35e
updated_at: 2023-12-14T05:12:00.0000000Z
original_content_git_url: https://github.com/MicrosoftDocs/linkedin-api-docs/blob/live/linkedin-api-docs/consumer/integrations/self-serve/share-on-linkedin.md
gitcommit: https://github.com/MicrosoftDocs/linkedin-api-docs/blob/dba38de9d1973312c5f3f989e034ab02c729c936/linkedin-api-docs/consumer/integrations/self-serve/share-on-linkedin.md
git_commit_id: dba38de9d1973312c5f3f989e034ab02c729c936
site_name: Docs
...
word_count: 1164
asset_id: consumer/integrations/self-serve/share-on-linkedin
moniker_range_name: 
monikers: []
item_type: Content
source_path: linkedin-api-docs/consumer/integrations/self-serve/share-on-linkedin.md
cmProducts:
...
platformId: 7d5ae864-7fff-4425-d224-a6f0c4e96fe0
---
...
New members Sharing on LinkedIn from your application for the first time will need to follow the [Authenticating with OAuth 2.0 Guide](../../../shared/authentication/authentication?context=linkedin/consumer/context). When requesting an authorization code in Step 2 of the OAuth 2.0 Guide, make sure to request the `w_member_social` scope!

| Permission Name | Description |
| --- | --- |
| w\_member\_social | Required to create a LinkedIn post on behalf of the authenticated member. |
...
| --- | --- | --- | --- |
| author | The author of a share contains Person URN of the Member creating the share. See [Sign In with LinkedIn using OpenID Connect](sign-in-with-linkedin-v2) to see how to retrieve the Person URN. | Person URN | Yes |
